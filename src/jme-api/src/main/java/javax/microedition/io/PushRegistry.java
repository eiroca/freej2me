...
public class PushRegistry {
  ...
  public static long registerAlarm(final String midlet, final long time) {
    return 0;
  }

  public static void registerConnection(final String connection, final String midlet, final String filter) {
  }
