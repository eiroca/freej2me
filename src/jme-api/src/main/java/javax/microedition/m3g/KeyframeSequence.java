...
public class KeyframeSequence extends Object3D {
  ...
  public int getKeyframe(final int index, final float[] value) {
    return keyframe;
  }
  ...
  public void setKeyframe(final int index, final int time, final float[] value) {
    keyframe = index;
  }
  ...
  public void setValidRange(final int first, final int last) {
    rangeFirst = first;
    rangeLast = last;
  }
